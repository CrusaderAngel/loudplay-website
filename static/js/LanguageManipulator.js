...
export default class LanguageManipulator {
        ...
        static getElementsToTranslate(pageName) {
            switch (pageName) {
                case 'technology':
                    return [".navbar-link", "#navbar-download-link-content", "#page-1-rectangle-element-header", ".page-1-text-content", "#navbar-download-link-content-mobile", ".page-1-rectangle-element-text", ".page-container-text-header", ".page-container-text-paragraph"];
                    break;
                case 'download':
